...
crea a su vez un container Docker con la imagen que se indique en el propio job, y és en este container donde se ejecutan los scripts, que se escriben en el lenguaje de shell asociado a la imagen docker, es decir, "sh", "bash", "PowerShell", etc.
