...
Job definido en link:jobs/maven/tf-apply-simple.yml[]. Se ejecuta sólamente en master. Definido como "manual".

==== Deploy

Para esta etapa se ha definido el job en el archivo link:jobs/maven/deploy-simple.yml[]. Se ejecuta sólamente en master. Definido como "manual".
